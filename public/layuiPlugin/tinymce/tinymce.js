...
layui.define(['jquery'],function (exports) {
    ...
    t.render = function (option,callback) {
        ...
        option.plugins = isset(option.plugins) ? option.plugins : 'quickbars print preview searchreplace autolink fullscreen image link media codesample table charmap hr advlist lists wordcount imagetools indent2em emoticons textpattern toc tinymce-latex';

        option.toolbar = isset(option.toolbar) ? option.toolbar : ['undo redo | forecolor backcolor bold italic underline strikethrough | indent2em alignleft aligncenter alignright alignjustify outdent indent | link bullist numlist image table codesample emoticons | toc tinymce-latex' ,' formatselect fontselect fontsizeselect'];
